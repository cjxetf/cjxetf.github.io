...
### Agent Skills 的典型应用场景

#### Agent Skills vs MCP

| 维度                 | Agent Skills     | MCP                   |
| ---------------------- | ------------------ | ----------------------- |
| **侧重点**     | 提示词（Prompt） | 工具调用（API/Code）  |
| **类比**       | 带目录的说明书   | 标准化工具箱          |
| **Token 消耗** | 低               | 高                    |
| **核心主体**   | Markdown 文件    | 软件包（Python 包等） |
| **编写难度**   | 低               | 高                    |
...
| 价值点                            | 说明                            |
| ----------------------------------- | --------------------------------- |
| ✅ **降低 Prompt 编写门槛** | 用文档代替纯文本，更易维护      |
| ✅ **促进团队协作**         | 所有人共享同一套“AI 操作手册” |
| ✅ **提升输出一致性**       | 固定格式减少幻觉                |
| ✅ **支持复杂任务编排**     | 可组合多个 Skill 实现流程       |
| ✅ **便于审计与优化**       | 每个 Skill 都可单独评估效果     |